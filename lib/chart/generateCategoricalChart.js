...
var generateCategoricalChart = function generateCategoricalChart(_ref) {
  ...
  return _temp = _class = /*#__PURE__*/function (_Component) {
    ...
    function CategoricalChartWrapper(_props) {
      ...
      _this.handleReceiveSyncEvent = function (cId, chartId, data) {
        ...
        if (syncId === cId && chartId !== _this.uniqueChartId) {
          var _data = data,
              dataStartIndex = _data.dataStartIndex,
              dataEndIndex = _data.dataEndIndex;
          ...
          if (!(0, _isNil2["default"])(data.dataStartIndex) || !(0, _isNil2["default"])(data.dataEndIndex)) {
            ...
            var _data2 = data,
                chartX = _data2.chartX,
                chartY = _data2.chartY;
            var _this$state2 = _this.state,
                offset = _this$state2.offset,
                tooltipTicks = _this$state2.tooltipTicks; // Set activeTooltipIndex to the index with the same value as data.activeLabel  

            var activeTooltipIndex = tooltipTicks.findIndex(function (_ref4, index) {
      ...
      _this.handleBrushChange = function (_ref5) {
      ...
      _this.verticalCoordinatesGenerator = function (_ref6) {
      ...
      _this.horizontalCoordinatesGenerator = function (_ref7) {
      ...
      _this.renderActivePoints = function (_ref8) {
        var item = _ref8.item,
            activePoint = _ref8.activePoint,
            basePoint = _ref8.basePoint,
            childIndex = _ref8.childIndex,
            isRange = _ref8.isRange;
        var result = [];
    ...
    _createClass(CategoricalChartWrapper, [{
      ...
      key: "getAxisMap",
      value: function getAxisMap(props, _ref9) {
        var _ref9$axisType = _ref9.axisType,
            axisType = _ref9$axisType === void 0 ? 'xAxis' : _ref9$axisType,
            AxisComp = _ref9.AxisComp,
            graphicalItems = _ref9.graphicalItems,
            stackGroups = _ref9.stackGroups,
      ...
      value: function updateStateOfAxisMapsOffsetAndStackGroups(_ref10) {
        var _this4 = this;

        var props = _ref10.props,
            dataStartIndex = _ref10.dataStartIndex,
            dataEndIndex = _ref10.dataEndIndex,
            updateId = _ref10.updateId;
      ...
      key: "calculateOffset",
      value: function calculateOffset(_ref11) {
        var props = _ref11.props,
            graphicalItems = _ref11.graphicalItems,
            _ref11$xAxisMap = _ref11.xAxisMap,
            xAxisMap = _ref11$xAxisMap === void 0 ? {} : _ref11$xAxisMap,
            _ref11$yAxisMap = _ref11.yAxisMap,
            yAxisMap = _ref11$yAxisMap === void 0 ? {} : _ref11$yAxisMap;
  ...
  }, _class.getDisplayedData = function (props, _ref12, item) {
    var graphicalItems = _ref12.graphicalItems,
        dataStartIndex = _ref12.dataStartIndex,
        dataEndIndex = _ref12.dataEndIndex;
